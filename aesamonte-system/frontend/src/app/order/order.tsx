  ...
  <div className={s.container}>
    ...
    <div className={s.mainContent}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        <div>
          <div className={s.skeleton} style={{ width: 120, height: 28, marginBottom: 8 }} />
          <div className={s.skeleton} style={{ width: 240, height: 13 }} />
        </div>
      ...
      <div style={{ background: 'white', border: '0.5px solid #e5e7eb', borderRadius: 12, padding: '1.1rem 1.25rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            {[100,100,34,200,60].map((w,i) => <div key={i} className={s.skeleton} style={{ width: w, height: 34, borderRadius: 6 }} />)}
          </div>
        </div>
        {[0,1,2,3,4,5,6,7].map(i => (
          <div key={i} style={{ display: 'flex', gap: 14, padding: '10px 0', borderBottom: '0.5px solid #e5e7eb' }}>
            {[40,120,140,40,80,80,70,80,40].map((w,j) => (
              <div key={j} className={s.skeleton} style={{ width: w, height: 12, borderRadius: j === 7 ? 20 : 4, flexShrink: 0 }} />
            ))}
          </div>
        ))}
      </div>
